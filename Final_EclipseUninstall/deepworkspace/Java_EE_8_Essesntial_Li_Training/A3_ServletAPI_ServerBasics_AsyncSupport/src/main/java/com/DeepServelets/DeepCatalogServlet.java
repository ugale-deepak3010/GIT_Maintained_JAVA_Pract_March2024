...
public class DeepCatalogServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		asyncContext.start(new Runnable() {
			...
			public void run() {
				try {
					...
					System.out.println("Response returned by Thread = "+Thread.currentThread().getName());
					deepReturnResp(request, response);
		...
		System.out.println("Intitial Request handle by Thread = "+Thread.currentThread().getName());

	}

	private void deepReturnResp(HttpServletRequest request, HttpServletResponse response) throws IOException {
